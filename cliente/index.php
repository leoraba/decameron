...
<li><img src="data1/images/d7.jpg" alt="" title="" id="wows1_4"/>Cada una de nuestras habitaciones esta equipada con todas las comodidades necesarias para que vivas una placentera estad�a, en donde tendr�s una experiencia �nica de relajaci�n, descanso y comodidad �Es hora de darte el descanso que te mereces!.</li>
...
<header>Tipo de habitacion:</header>
    <select id="t_hab" name="t_hab" class="form-control">
